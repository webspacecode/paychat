...
<body>
  <div class="receipt">
    <div class="center">
      ${t.shopLogoUrl?`<img class="shop-logo" src="${T(t.shopLogoUrl)}" alt="${T(t.shopName)}" />`:""}
    ...
    <div class="center muted">
      ${t.paychatLogoUrl?`<img class="paychat-logo" src="${T(t.paychatLogoUrl)}" alt="PayChat" />`:""}
      Powered by PayChat
    </div>
  </div>
</body>
...
`},g=(t,e,o)=>{const n=A(e),i=Math.max(1,o-n.length-1),r=A(t).slice(0,i),s=Math.max(1,o-r.length-n.length);return`${r}${" ".repeat(s)}${n}
`},M=(t,e)=>{const o=A(t).split(/\s+/).filter(Boolean).flatMap(r=>r.length<=e?[r]:r.match(new RegExp(`.{1,${e}}`,"g"))||[r]),n=[];let i="";return o.forEach(r=>{if(!i){i=r;return}(i+" "+r).length<=e?i+=` ${r}`:(n.push(i),i=r.slice(0,e))}),i&&n.push(i),n.length?n:[""]},pt=(t,e)=>{const o=M(t.name,e),n=`${L(t.qty)} x ${d(t.rate)}`;return[...o.map(i=>`${i}
...
`);const m=xt(t,r),u={text:s,html:a,print_mode:n.printMode};return m&&wt(m)&&(u.qr={data:m,size:6,error_correction:"M"}),u},kt=async(t=S())=>{const e=v(t);return I(C("/health",e,{size:void 0,printer_name:void 0,copies:void 0,print_mode:void 0}),{method:"GET"})},At=async(t=S())=>{const e=v(t),o=await I(C("/printers",e,{size:void 0,printer_name:void 0,copies:void 0,print_mode:void 0}),{method:"GET"});return Array.isArray(o)?o:Array.isArray(o?.printers)?o.printers:Array.isArray(o?.data)?o.data:[]},Tt=async(t=S())=>{const e=v(t);return I(C("/test-print",e),{method:"POST"})},Nt=async(t={},e={})=>{const o=v(e.settings||S()),n=X(t,e.context||{},o);return I(C("/print",o),{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(n)})},qt={getSettings:S,saveSettings:yt,checkHealth:kt,getPrinters:At,testPrint:Tt,printReceipt:Nt,buildSafeAgentReceiptPayload:X},zt={list(t={}){return k.get("/upi-profiles",{params:t})},create(t){return k.post("/upi-profiles",t)},update(t,e){return k.patch(`/upi-profiles/${t}`,e)},deactivate(t){return k.delete(`/upi-profiles/${t}`)},setDefault(t){return k.patch(`/upi-profiles/${t}/default`)}},E="paychat_pos_wake_lock_enabled",G=()=>{try{return localStorage.getItem(E)==="true"}catch{return!1}},Ut=t=>{try{return t?(localStorage.setItem(E,"true"),!0):(localStorage.removeItem(E),!1)}catch{return!1}},Lt=()=>typeof navigator>"u"?{supported:!1,reason:"browser_unavailable"}:"wakeLock"in navigator?typeof window<"u"&&window.isSecureContext===!1?{supported:!1,reason:"insecure_context"}:{supported:!0,reason:"supported"}:{supported:!1,reason:"unsupported_browser"},Rt=()=>{let t=null,e=!1,o=!1,n=0;const i=async()=>{try{await t?.release?.()}catch(l){console.warn("POS wake lock release failed:",l)}finally{t=null}},r=()=>{const l=Lt();return l.supported?!0:(o||(console.warn(`POS wake lock unavailable: ${l.reason}`),o=!0),!1)},s=async()=>{const l=Date.now();if(!(e||t||!G()||!r()||document.visibilityState!=="visible")&&!(l-n<750)){n=l;try{t=await navigator.wakeLock.request("screen"),t.addEventListener?.("release",()=>{t=null})}catch(f){console.warn("POS wake lock failed:",f)}}},a=()=>{s()},m=()=>{document.visibilityState==="visible"?s():i()},u=l=>{l.key===E&&(G()?s():i())};return document.addEventListener("visibilitychange",m),document.addEventListener("pointerdown",a,{passive:!0}),document.addEventListener("touchstart",a,{passive:!0}),document.addEventListener("click",a,{passive:!0}),window.addEventListener("storage",u),s(),()=>{e=!0,document.removeEventListener("visibilitychange",m),document.removeEventListener("pointerdown",a),document.removeEventListener("touchstart",a),document.removeEventListener("click",a),window.removeEventListener("storage",u),i()}},Pt="paychat-pos",N="cache",z=Z(Pt,1,{upgrade(t){t.createObjectStore(N)}}),Ot={async set(t,e){await(await z).put(N,e,t)},async get(t){return await(await z).get(N,t)},async clear(){await(await z).clear(N)}};export{lt as a,It as b,Ot as c,Ut as d,Lt as e,G as g,ct as n,qt as p,Rt as s,zt as u};
