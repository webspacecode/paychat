...
class SyncOfflineOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'dining_flow' => ['nullable', Rule::in(['table_service', 'quick_counter'])],
            'guest_count' => ['nullable', 'integer', 'min:1'],
            'primary_table_id' => ['nullable', 'integer'],
            'linked_table_ids' => ['nullable', 'array'],
            'linked_table_ids.*' => ['integer', 'distinct'],
            'table_group_label' => ['nullable', 'string', 'max:255'],
            'table_snapshot' => ['nullable', 'array'],
            'table_session_snapshot' => ['nullable', 'array'],
            'source_flow' => ['nullable', 'string', 'max:80'],
