...
`   <meta name="description" content="Contact PayChat team for demo, pricing and onboarding.">
    <title>Contact PayChat - Book Demo or Talk to Sales</title>
...
<body class="font-sans">
  ...
  <div class="max-w-3xl mx-auto px-6 text-center">
    ...
    <h1 class="text-4xl font-bold text-navy mb-4">Contact Us</h1>
    <p class="text-gray-600 mb-8">We’ll help you get started with PayChat</p>

    <div class="bg-white p-8 rounded-xl shadow">

      <input id="name" placeholder="Your Name" class="w-full p-4 mb-4 border rounded-xl">
      <input id="phone" placeholder="Phone Number" class="w-full p-4 mb-4 border rounded-xl">
      <input id="business" placeholder="Business Name" class="w-full p-4 mb-4 border rounded-xl">

      <button onclick="sendWhatsApp()" class="w-full bg-green-500 text-white py-3 rounded-xl">
        Send on WhatsApp →
      </button>
    ...
    const msg = `Hi PayChat,%0AName: ${name}%0APhone: ${phone}%0ABusiness: ${business}`;
