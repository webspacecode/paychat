...
<head>
    ...
    <meta name="description" content="Flexible pricing plans for PayChat POS. Choose based on your business scale and order volume.">
    <title>PayChat Pricing - Flexible Plans for Every Business</title>
...
<body class="font-sans">
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <h1 class="text-4xl font-bold text-navy mb-4">Simple & Scalable Pricing</h1>
            <p class="text-gray-600 mb-12">Choose a plan based on your business size</p>
            ...
            <div class="bg-white p-8 rounded-xl shadow">
                ...
                <p class="mb-4 text-gray-500">For small shops</p>
                <ul class="text-sm space-y-2 mb-6">
                <li>✔ Limited Orders</li>
                <li>✔ Vendor POS</li>
                <li>✔ Basic Reports</li>
                </ul>
                <button onclick="openContact()" class="bg-indigo-600 text-white px-6 py-2 rounded-lg">Contact Sales</button>
            </div>

            <!-- Growth -->
            <div class="bg-white p-8 rounded-xl shadow border-2 border-indigo-500">
                <h3 class="text-xl font-bold mb-4">Growth</h3>
                <p class="mb-4 text-gray-500">For growing businesses</p>
                <ul class="text-sm space-y-2 mb-6">
                <li>✔ Higher Order Limits</li>
                <li>✔ QR Self POS</li>
            ...
            <div class="bg-white p-8 rounded-xl shadow">
                ...
                <p class="mb-4 text-gray-500">For multi-branch & scaling</p>
                <ul class="text-sm space-y-2 mb-6">
