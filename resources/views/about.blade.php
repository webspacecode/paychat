...
<head>
    ...
    <meta name="description" content="Learn about PayChat, our mission to simplify business operations with a unified POS system.">
    <title>About PayChat - Our Vision</title>
...
<body class="font-sans">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <h1 class="text-4xl font-bold text-navy mb-6">About PayChat</h1>

            <p class="text-gray-600 mb-6">
            PayChat is built to simplify how businesses operate. From billing and inventory to customer engagement, everything is handled in one platform.
            </p>

            <p class="text-gray-600 mb-6">
            Our goal is to remove complexity and bring powerful tools to small and medium businesses without expensive systems.
            </p>

            <p class="text-gray-600">
            We are currently working with early customers to build the future of POS systems in India.
            </p>
