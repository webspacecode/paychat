...
<head>
    ...
    <meta name="description" content="Explore PayChat features: POS billing, QR self ordering, token system, inventory, reports and more.">
    <title>PayChat Features - Complete POS & Business Tools</title>
...
<body class="font-sans">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <h1 class="text-4xl font-bold text-navy">Powerful Features for Modern Businesses</h1>
            <p class="text-gray-600 mt-4">Everything you need to run, scale and automate your business</p>
            </div>

            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Vendor POS</h3>
                <p>Fast billing system designed for shop staff with minimal clicks and high speed checkout.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Self POS (QR Ordering)</h3>
                <p>Customers scan QR on table and place orders directly without staff dependency.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Token Management</h3>
                <p>Manage queues for dine-in or service businesses using QR-based token system.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Paperless Billing</h3>
                <p>Invoices, tokens, and receipts handled digitally via QR. No paper required.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">WhatsApp Invoice Sharing</h3>
                <p>Send invoices instantly to customers via WhatsApp after checkout.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Optional Printing</h3>
                <p>Print invoices when needed—completely optional.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Multi-Branch Management</h3>
                <p>Manage multiple stores from one dashboard.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Product Management</h3>
                <p>Bulk upload products and manage catalogs easily.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Inventory Management</h3>
                <p>Real-time stock tracking with auto updates.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Order Management</h3>
                <p>View and manage all orders in one place.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Sales Reports</h3>
                <p>Daily reports with insights into your business performance.</p>
            </div>

            <div class="p-6 border rounded-xl">
                <h3 class="font-bold text-xl mb-2">Custom Features</h3>
                <p>We customize modules based on your business needs.</p>
            </div>
